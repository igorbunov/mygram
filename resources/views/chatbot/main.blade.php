    ...
    <div class="container container-nopadding">
        <section id="chatbot-instruction" class="chatbot-container">
            ...
            <div class="row">
                ...
                <div class="chatbot-stats-block">
                    <div>Взято номеров: (сегодня): <span class="chatbot-numbers-today">{{ $takenPhonesTodayCount }}</span></div>
                    <div>(всего): <span class="chatbot-numbers-all">{{ $takenPhonesAllTimeCount }}</span></div>
                </div>
            </div>
        </section>
