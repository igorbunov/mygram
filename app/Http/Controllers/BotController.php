...
class BotController
{
    ...
    private $negativeAnswers = [
        ...
        'вжє робота', 'мене е робота', 'ні дякую', 'нецікаво', 'сама ищу', 'сам ищу',  'клуб', 'не хочу', 'уже в', 'не очень',
        'nope', 'no thanks', 'no need', 'уже с вами', 'работаем уже', 'уже работаем', 'идеального', 'колега', 'колеги', 'не заинтересован'
    ];
